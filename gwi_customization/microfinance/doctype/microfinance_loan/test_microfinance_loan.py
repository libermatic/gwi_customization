...
import frappe
import unittest
from gwi_customization.microfinance.doctype.microfinance_loanee.test_microfinance_loanee import (  # noqa
    create_test_loanee,
    remove_test_loanee,
)
...
class TestMicrofinanceLoan(unittest.TestCase):
    ...
    def test_billing_start_date(self):
        ...
        self.assertEqual(loan.billing_start_date, frappe.utils.getdate("2017-12-01"))
    ...
    def test_accounts(self):
        ...
        loan = create_test_loan(do_not_submit=True)
        self.assertEqual(loan.loan_account, loan_account)
        self.assertEqual(loan.interest_income_account, interest_income_account)

    def test_raises_when_recovery_more_than_principal(self):
        with self.assertRaises(frappe.exceptions.ValidationError):
            create_test_loan(loan_principal=10000.0, recovery_amount=10001.0)
